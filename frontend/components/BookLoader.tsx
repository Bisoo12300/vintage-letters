export function BookLoader({ label }: { label?: string }) {
  return (
    <div className="book-loader flex flex-col items-center justify-center gap-4" role="status" aria-live="polite">
      <div className="book-loader-wrapper">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="white"
          viewBox="0 0 126 75"
          className="book-loader-book"
          aria-hidden
        >
          <rect strokeWidth={5} stroke="#e05452" rx="7.5" height={70} width={121} y="2.5" x="2.5" />
          <line strokeWidth={5} stroke="#e05452" y2={75} x2="63.5" x1="63.5" />
      ...
      {label && (
        <p className="font-body text-sm text-mora-brown-500">{label}</p>
      )}
