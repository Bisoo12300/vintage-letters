...
import { apiFetch, TEMPLATES } from '@/lib/api';
    ...
    <SiteShell>
      ...
      <section className="mx-auto max-w-3xl px-5 pb-20 sm:px-8">
        ...
        <form onSubmit={handleSubmit} className="mora-card space-y-6">
          <div>
            <h2 className="font-display mb-1 text-xl font-semibold text-mora-brown-800">Compose</h2>
            <p className="font-body text-sm text-mora-brown-500">Select paper and begin writing</p>
          </div>
